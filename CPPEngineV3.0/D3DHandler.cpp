...
bool D3DHandler::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
void D3DHandler::TurnOnAlphaBlending()
{
	float blendFactor[4];
...
void D3DHandler::TurnOffAlphaBlending()
{
	float blendFactor[4];
