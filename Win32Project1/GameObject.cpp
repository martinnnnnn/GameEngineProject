...
GraphicsComponent * const GameObject::GetGraphicsComponent() const
{
	return _graphics;
}

PhysicsComponent * const GameObject::GetPhysicsComponent() const
{
	return _physics;
}
...
const GameObject & GameEngineProject::GameObject::operator=(const GameObject & obj)
{
	_id = obj._id;
	_name = obj._name;
	_tag = obj._tag;
	_shotdown = obj._shotdown;
	_transform = obj.GetTransform();
	_graphics = obj.GetGraphicsComponent();
	_physics = obj.GetPhysicsComponent();
